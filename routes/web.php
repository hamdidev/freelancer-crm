...
Route::middleware('auth')->group(function () {
    ...
    // Send portal magic link to a client
...
Route::prefix('portal')->name('portal.')->group(function () {
    ...
    Route::post('/login', [PortalAuthController::class, 'requestLink'])->name('request-link');
    Route::get('/auth/{token}', [MagicLinkController::class, 'authenticate'])->name('authenticate');
    Route::get('/session-expired', fn () => inertia('Portal/SessionExpired'))->name('session-expired');

    // Protected — requires client auth
